...
class Chemicals(Product):
    """
    Класс, представляющий бытовую химия, наследующий класс Product.
    """
    def __init__(self, name, price, chemical_composition):
    ...
    def get_details(self):
        ...
        return f"{base_details}, Состав: {self.chemical_composition}"